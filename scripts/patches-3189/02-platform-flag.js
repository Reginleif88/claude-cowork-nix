#!/usr/bin/env node
/**
 * Patch 02: Platform Flag (for Claude Desktop 1.1.3189)
 *
 * Makes `Ci` (Windows platform flag) also true on Linux.
 ...
 * v3189: Ci=process.platform==="win32"
 */
const fs = require('fs');
...
console.log('=== Patch 02: Platform Flag (3189) ===\n');
...
if (indexContent.includes(original)) {
  ...
  console.log('  Patched Ci flag to include Linux\n');
} else {
  console.log('  WARNING: Ci flag pattern not found\n');
}
